#!/usr/bin/env python3
"""Install Workflow's optional native Codex roles (Python 3.11+)."""
...
def main() -> None:
    ...
    for name in ("workflow-planner", "workflow-implementer", "workflow-reviewer"):
    ...
    print("Start a new Codex session with workflow enabled to use these roles.")
